    ...
    return (
        <div className="fp">
            <div className="fpItem">
                ...
                <span className="fpName">Hotel Horison</span>
                <span className="fpCity">Pangandaran</span>
                <span className="fpPrice">Starting from Rp 200.000</span>
            ...
            <div className="fpItem">
                <img src="https://cf.bstatic.com/xdata/images/hotel/max1280x900/322658536.jpg?k=3fffe63a365fd0ccdc59210188e55188cdb7448b9ec1ddb71b0843172138ec07&o=&hp=1" alt="" className="fpImg" />
                <span className="fpName">Hotel Horison</span>
                <span className="fpCity">Pangandaran</span>
                <span className="fpPrice">Starting from Rp 200.000</span>
                <div className="fpRating">
